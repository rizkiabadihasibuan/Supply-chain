 ...
 * resources/js/admin/articles/article.js
 * ============================================================
 */
...
const ArticlesCore = (() => {
    ...
    function showToast(message) {
        ...
        if (message.includes('berhasil') || message.includes('impor') || message.includes('Import') || message.includes('ditambahkan') || message.includes('diperbarui') || message.includes('dihapus') || message.includes('dipublikasikan') || message.includes('diarsipkan') || message.includes('diduplikasi')) {
            const successAlertContainer = document.getElementById('articles-success-alert-container');
            const successAlertText = document.getElementById('articles-success-alert-text');
