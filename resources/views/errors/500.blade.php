...
<div class="d-flex flex-column align-items-center justify-content-center" style="min-height:60vh; text-align:center;">
    <div class="mb-4">
        <i class="bi bi-server display-1 text-secondary opacity-50"></i>
    </div>
    <h1 class="display-4 fw-bold text-dark">500</h1>
    <h2 class="h4 fw-semibold mb-3">Kesalahan Server Internal</h2>
    <p class="text-muted mb-4 col-md-6">Terjadi kesalahan pada server. Tim kami sedang menanganinya.</p>
