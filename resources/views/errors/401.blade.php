...
<div class="d-flex flex-column align-items-center justify-content-center" style="min-height:60vh; text-align:center;">
    <div class="mb-4">
        <i class="bi bi-lock-fill display-1 text-secondary opacity-50"></i>
    </div>
    <h1 class="display-4 fw-bold text-dark">401</h1>
    <h2 class="h4 fw-semibold mb-3">Tidak Terautentikasi</h2>
    <p class="text-muted mb-4 col-md-6">Anda perlu login untuk mengakses halaman ini.</p>
