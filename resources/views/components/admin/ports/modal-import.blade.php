{{-- ═══════════════════════════════════════════════════
     PORT MODAL IMPORT CSV COMPONENT – Milestone 3.15C
     resources/views/components/admin/ports/modal-import.blade.php
     ═══════════════════════════════════════════════════ --}}

<div class="modal fade" id="portImportModal" tabindex="-1" aria-labelledby="portImportModalLabel" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            {{-- Modal Header --}}
            <div class="modal-header">
                <h6 class="modal-title fw-bold text-dark" id="portImportModalLabel"><i class="bi bi-upload text-success me-2"></i>Impor Dataset Pelabuhan (CSV)</h6>
                ...
                <div id="import-preview-section" style="display: none;" class="mb-3 text-start">
                    ...
                    <div class="border rounded p-2.5 bg-light d-flex align-items-center justify-content-between mb-3">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <span class="small fw-semibold text-dark" id="csv-filename">dataset_pelabuhan.csv</span>
                        </div>
                    ...
                    <div class="row g-2 text-center">
                        <div class="col-4">
                            <div class="border rounded p-2.5 bg-light">
                                ...
                                <span class="fw-bold text-dark fs-5" id="csv-total-records">120</span>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="border rounded p-2.5 bg-success bg-opacity-10">
                                ...
                                <span class="fw-bold text-success fs-5" id="csv-success-records">118</span>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="border rounded p-2.5 bg-danger bg-opacity-10">
                                <span class="text-danger d-block" style="font-size: 0.65rem;">Gagal</span>
                                <span class="fw-bold text-danger fs-5" id="csv-failed-records">2</span>
                            </div>
                        </div>
                    </div>
                </div>
